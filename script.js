    ...
    function toggleGlobalView() {
      ...
      window.__viewerGlobalViewActive = true;
      markQuickPreviewTask({ warehouseUsed: true });
    ...
    async function openCardImageLightbox(card) {
      ...
      if (reuse && typeof openLightbox === 'function') {
        openLightbox(reuse, {
          cardId: card.id,
          preferFull: true,
      ...
      if (typeof openLightbox === 'function') {
        openLightbox('', { pending: true, cardId: card.id, preferFull: true, fallbackSrc: gridOk ? gridFallback : '' });
      }
      let url = '';
    ...
    function loadLightboxImage(displaySrc, opts) {
      ...
      const upgradeImageGenFull = () => {
        ...
        const viewerNav = window.getViewerNav();
