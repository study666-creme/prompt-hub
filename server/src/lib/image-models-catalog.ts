...
/** MJ uses the APIMart upstream, with one public price per generation call. */
export const APIMART_IMAGE_MODEL_CATALOG: ImageModelCatalogEntry[] = [
  apimart(midjourney({
    ...
    group: 'new',
    description: 'Midjourney 8.1 常规版，固定 Relax；一次提交返回四宫格封面和 4 张单图。',
    upstreamPoints: 0.4,
    refundOnViolation: true,
    resolutions: ['1k'],
    defaultCredits: 40,
  ...
  apimart(midjourney({
    ...
    label: 'Midjourney 7',
    group: 'classic',
    description: 'Midjourney 7 常规版，固定 Relax；一次提交返回四宫格封面和 4 张单图。',
    upstreamPoints: 0.4,
    refundOnViolation: true,
    resolutions: ['1k'],
    defaultCredits: 40,
  ...
  apimart(midjourney({
    ...
    group: 'new',
    description: 'Midjourney Niji 7 常规版，适合动漫、角色和插画；固定 Relax，一次提交返回 5 张图。',
    upstreamPoints: 0.4,
    refundOnViolation: true,
    resolutions: ['1k'],
    defaultCredits: 40,
