...
> 最后更新：**2026-06-07** · Pages 构建号 **`20260623e`**
...
| **`*.bundle.js?v=` 查询串** | MIME `text/html`；`FeedImages.init` 报 undefined；全站无图 | Pages 对 `*.bundle.js?任意参数` SPA 回退成 HTML（普通 `.js?v=` 正常） | `index.html` 里 bundle **禁止** `?v=`；靠 `_headers` no-cache + 部署换文件 |
