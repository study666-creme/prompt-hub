...
前端当前积分包：100、500、1000、3000、5000、10000 积分，对应 ¥1、¥5、¥10、¥30、¥50、¥100。积分充值固定 `1 元 = 100 积分`，不打折、不赠送会员天数；批量备货可使用 `scripts/generate-shop-codes.ps1`。
...
- 不承诺固定生成张数；模型和分辨率会影响积分消耗，实时价格以生成页报价为准。
