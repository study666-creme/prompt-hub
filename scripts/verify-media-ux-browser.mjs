...
const fixtureModels = [
  ...
  { id: 'image2-4k-fast', label: '全能模型2 · 4K', uiFamily: 'gim2', sortOrder: 24, status: 'active', selectable: true, refundOnViolation: true, creditsPerCall: 6, creditsFinal: 6, creditsByResolution: { '4k': 6 }, resolutions: ['4k'] },
